...
class CoreOptionGroup {
	...
	public function output_link() {
		...
		echo ' <i class="icon-double-angle-right"></i></div><div class="endpoint"></div></li>';
	}
...
class CoreOption {
	...
	function __construct($slug, $title, $type, $description=null, $default=null, $class=null) {
		$this->slug = $slug;
		$this->title = $title;
		$this->type = $type;
		$this->description = $description;
	...
	public function output() {
		...
		echo '<div id="core-option-', $this->slug, '" class="core-option ', $this->class, '">';
