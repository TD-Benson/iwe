...
(function($){
	...
	theme = {
		...
		----------------------------*/
	 	_init : function(){
    		...
    		if (api.options.autoplay){
				...
				if ($(vars.play_button).hasClass('icon-play')) $(vars.play_button).addClass("icon-pause").removeClass("icon-play");	// If pause play button is image, swap src
		...
		----------------------------*/
	 	playToggle : function(state){
	 		...
	 		if (state =='play'){
	 			...
	 			if ($(vars.play_button).hasClass('icon-play')) $(vars.play_button).addClass("icon-pause").removeClass("icon-play");
				if (api.options.progress_bar && !vars.is_paused) theme.progressBar();
	 		}else if (state == 'pause'){
	 			// If image, swap to play
	 			if ($(vars.play_button).hasClass('icon-pause')) $(vars.play_button).addClass("icon-play").removeClass("icon-pause");
	 ...
	 $.supersized.themeVars = {
		...
		// General Elements							
		play_button			:	'#sliderPlayPause',		// Play/Pause button
		next_slide			:	'#sliderNext',		// Next slide button
		prev_slide			:	'#sliderPrev',		// Prev slide button
